...
|: ------------- |:-------------|:-----:|:-----------|
| [gmaps-ng7](https://github.com/aless80/gmaps-ng7) | MEAN stack (MongoDB, Express, Angular, Node.js), Google Maps API, RxJS | <progress value="60" max="100" style="width:80px"></progress>  | MEAN app for searching and storing zero-waste shops on Google Maps|
